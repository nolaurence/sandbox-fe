...
import ShellToolView from '../components/ShellToolView';
import FileToolView from '../components/FileToolView';
import SearchToolView from '../components/SearchToolView';
import BrowserToolView from '../components/BrowserToolView';
