...
import SimpleBar, {type ScrollableContentRef} from '@/app/components/SimpleBar';
import ToolPanel, {type ToolPanelRef} from '@/app/components/ToolPanel';
import {chatWithAgent} from '@/services/api/sandbox';
import type {Message, MessageContent, ToolContent, StepContent} from '@/app/types/message';
// @ts-ignore
import {ArrowDown, Bot, Clock, ChevronUp, ChevronDown, PanelLeft} from 'lucide-react';
// import { history } from '@umijs/max';
import {useNavigate, useLocation} from "react-router";
// import { useParams } from 'umi';
import StepSuccessIcon from '@/app/components/icons/StepSuccessIcon';
import type {MessageEventData, StepEventData, ToolEventData, PlanEventData} from '@/app/types/sseEvent';
import '@/app/assets/global.css';
import '@/app/assets/theme.css';
import {useStyles} from '@/app/style/chatPageStyle';
